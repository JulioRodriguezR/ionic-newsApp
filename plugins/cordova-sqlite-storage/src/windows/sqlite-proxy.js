    ...
    open: function(win, fail, args) {
        ...
        function openImmediate(dbname) {
            if (!!dbmap[dbname]) {
                ...
                fail(
                    'INTERNAL ERROR: database already open for dbname: ' +
                        dbname,
                );
            }
            ...
            var opendbname =
                ...
                dbname;
            console.log(
                'open db name: ' + dbname + ' at full path: ' + opendbname,
            );
    ...
    close: function(win, fail, args) {
        ...
        try {
            ...
            nextTick(function() {
                ...
                if (!db) {
                    fail(
                        'CLOSE ERROR: cannot find db object for dbname: ' +
                            dbname,
                    );
            ...
            try {
                ...
                if (rowsAffected > 0) {
                    ...
                    if (lastInsertRowid !== 0)
                        result.insertId = lastInsertRowid;
                }
                results.push({
                    type: 'success',
                    result: result,
            ...
            WinJS.Application.local.exists(dbname).then(function(isExisting) {
                ...
                Windows.Storage.ApplicationData.current.localFolder
                    ...
                    .then(
                        ...
                        function(e) {
                            console.log(
                                'get file failure: ' + JSON.stringify(e),
                            );
                            // XXX FUTURE TBD consistent for all platforms:
                            fail(e);
                        },
