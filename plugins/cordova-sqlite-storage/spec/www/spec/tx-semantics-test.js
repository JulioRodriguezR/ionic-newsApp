...
var mytests = function() {
    for (var i = 0; i < scenarioCount; ++i) {
        ...
        describe(scenarioList[i] + ': tx semantics test(s)', function() {
                    ...
                    db.transaction(
                        ...
                        function() {
                            db.transaction(function(tx) {
                                tx.executeSql('SELECT * FROM tt', [], function(
                                    tx,
                                    res,
                                ) {
                                    expect(res).toBeDefined();
                                    ...
                                    expect(res.rows.item(2).data).toBe(
                                        'middle',
                                    );
                                    done();
                                });
            ...
            it(
                suiteName +
                    'transaction test: check rowsAffected [intermediate]',
                function(done) {
                    var db = openDatabase(
                        'RowsAffected',
                        '1.0',
                    ...
                    function test1(tx) {
                        ...
                        tx.executeSql(
                            'CREATE TABLE IF NOT EXISTS characters (name, creator, fav tinyint(1))',
                        );
                        tx.executeSql(
                                    ...
                                    function(tx, res) {
                                        ...
                                        tx.executeSql(
                                            ...
                                            function(tx, res) {
                                                ...
                                                tx.executeSql(
                                                    'UPDATE characters SET fav=1 WHERE creator=?',
                                                    ['Nintendo'],
                                                    function(tx, res) {
                                                        expect(
                                                            res.rowsAffected,
                                            ...
                                            function(tx, res) {
                                                ...
                                                tx.executeSql(
                                                    ...
                                                    function(tx, res) {
                                                        ...
                                                        tx.executeSql(
                                                            'UPDATE characters SET fav=0,name=?',
                                                            ['foo'],
                                                            function(tx, res) {
                                                                expect(
                                                                    res.rowsAffected,
            ...
            it(
                suiteName +
                    'test insertId & rowsAffected [advanced] - plugin vs (WebKit) Web SQL',
                function(done) {
                    ...
                    db.transaction(
                        function(tx) {
                            tx.executeSql('DROP TABLE IF EXISTS characters');
                            tx.executeSql(
                                'CREATE TABLE IF NOT EXISTS characters (name unique, creator, fav tinyint(1))',
                            );
                            tx.executeSql('DROP TABLE IF EXISTS companies');
                            tx.executeSql(
                                'CREATE TABLE IF NOT EXISTS companies (name unique, fav tinyint(1))',
                            );
                                    ...
                                    tx.executeSql(
                                        ...
                                        function(txIgnored, rs2) {
                                            ...
                                            tx.executeSql(
                                                ...
                                                ['Sega', 1],
                                                function(txIgnored, rs3) {
                                                    expect(
                                                        rs3.rowsAffected,
                                                    ).toBe(1);
                                                    expect(rs3.insertId).toBe(
                                                        1,
                                                    );
                                                    ...
                                                    tx.executeSql(
                                                        ...
                                                        function(
                                                            ...
                                                            try {
                                                                ...
                                                                if (!isWebSql)
                                                                    expect(
                                                                        'EXCEPTION NOT EXPECTED on plugin with message: ' +
                                                                            ex.message,
                                                                    ).toBe(
                                                                        '--',
                                                                    );
                                                                ...
                                                                function(
                                                                    ...
                                                                    tx.executeSql(
                                                                        ...
                                                                        function(
                                                                            ...
                                                                            logError(
                                                                                'knockoff should have been ignored',
                                                                            );
                                                                            expect(
                                                                                error.message,
                                                                            ).toBe(
            ...
            describe(
                suiteName + 'transaction callback semantics test(s)',
                function() {
                    ...
                    it(
                        suiteName + 'transaction encompasses all callbacks',
                        function(done) {
                            var db = openDatabase(
                                'tx-all-callbacks.db',
                                '1.0',
                            ...
                            db.transaction(function(tx) {
                                ...
                                db.transaction(
                                                ...
                                                tx.executeSql(
                                                    ...
                                                    function(tx, res) {
                                                        expect(
                                                            res.rows.item(0)
                                                                .cnt,
                                                        ).toBe(1); // did insert row
                                                        throw new Error(
                                                            'deliberately aborting transaction',
                                                        );
                                                    },
                                                );
                                            },
                                        ...
                                        db.transaction(function(tx) {
                                            tx.executeSql(
                                                ...
                                                function(tx, res) {
                                                    ...
                                                    expect(
                                                        res.rows.item(0).cnt,
                                                    ).toBe(0); // final count shows we rolled back
                                    ...
                                    function() {
                                        ...
                                        logError(
                                            "transaction succeeded but wasn't supposed to",
                                        );
                                        done.fail();
                                        expect(error.message).toBe('--');
                    ...
                    it(
                        suiteName +
                            'exception from transaction handler causes failure',
                        function(done) {
                            var db = openDatabase(
                                'exception-causes-failure.db',
                                '1.0',
                                'Demo',
                                DEFAULT_SIZE,
                            );
                            ...
                            try {
                                ...
                                logSuccess(
                                    'db.transaction() did not throw an error',
                                );
                            } catch (ex) {
                    ...
                    it(
                        suiteName +
                            'exception with code from transaction handler',
                        function(done) {
                            var db = openDatabase(
                                'exception-with-code.db',
                                '1.0',
                                'Demo',
                                DEFAULT_SIZE,
                            );
                    ...
                    it(
                        suiteName +
                            'error handler returning true causes rollback',
                        function(done) {
                                        ...
                                        db.transaction(function(tx) {
                                            tx.executeSql(
                                                ...
                                                function(tx, res) {
                                                    ...
                                                    expect(
                                                        res.rows.item(0).cnt,
                                                    ).toBe(0); // should have rolled back
                    ...
                    it(
                        suiteName +
                            'error handler returning false lets transaction continue',
                        function(done) {
                            var check1 = false;
                            withTestTable(function(db) {
                                db.transaction(
                                            ...
                                            function(tx, res) {
                                                ...
                                                tx.executeSql(
                                                    ...
                                                    function(tx, res) {
                                                        // NOT EXPECTED:
                                                        logError(
                                                            'select statement not supposed to succeed',
                                                        );
                                                        done.fail();
                                                    },
                                                    function(tx, err) {
                                                        ...
                                                        expect(
                                                            err.message,
                                                        ).toBeTruthy(); // should report a valid error message
                                                        return false;
                                                    },
                                                );
                                            },
                                    ...
                                    function(error) {
                                        // ERROR NOT EXPECTED here:
                                        logError(
                                            'transaction was supposed to succeed: ' +
                                                error.message,
                                        );
                                        expect(error.message).toBe('--');
                                        done.fail();
                    ...
                    it(
                        suiteName + 'missing error handler causes rollback',
                        function(done) {
                            withTestTable(function(db) {
                                db.transaction(
                                    function(tx) {
                    ...
                    it(
                        suiteName + 'executeSql fails outside transaction',
                        function(done) {
                            var check1 = false;
                            withTestTable(function(db) {
                                ...
                                db.transaction(
                                    ...
                                    function(error) {
                                        // ERROR NOT EXPECTED here:
                                        logError(
                                            'unexpected error callback with message: ' +
                                                error.message,
                                        );
                                        expect(error.message).toBe('--');
                                        done.fail();
                                    ...
                                    function() {
                                        ...
                                        try {
                                            ...
                                            logError(
                                                'executeSql should have thrown but continued instead',
                                            );
                                            done.fail();
                                        } catch (err) {
            ...
            it(
                suiteName +
                    'readTransaction should fail & report error on modification',
                function(done) {
                    var db = openDatabase(
                        'tx-readonly-test.db',
                        '1.0',
                    ...
                    db.transaction(
                        function(tx) {
                            tx.executeSql('DROP TABLE IF EXISTS test_table');
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable1',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable2',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable3',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable4',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable5',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS ExtraTestTable6',
                            );
                            tx.executeSql(
                                'DROP TABLE IF EXISTS AlterTestTable',
                            );

                            tx.executeSql('CREATE TABLE test_table (data)');
                            tx.executeSql('INSERT INTO test_table VALUES (?)', [
                                'first',
                            ]);

                            tx.executeSql(
                                'CREATE TABLE AlterTestTable (FirstColumn)',
                            );
                        },
                        function() {},
                        function() {
                                ...
                                function() {
                                    ...
                                    function fail() {
                                        if (!failed) {
                                            expect(false).toBe(true);
                                            expect(
                                                'readTransaction was supposed to fail',
                                            ).toBe('--');
                                            failed = true;
                                    ...
                                    tasks = [
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        'UPDATE test_table SET foo = "another"',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        'INSERT INTO test_table VALUES ("another")',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        ';  CREATE TABLE ExtraTestTable1 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        ' ;  CREATE TABLE ExtraTestTable2 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        ';CREATE TABLE ExtraTestTable3 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        ';; CREATE TABLE ExtraTestTable4 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        '; ;CREATE TABLE ExtraTestTable5 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        '; ; CREATE TABLE ExtraTestTable6 (data)',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        'ALTER TABLE AlterTestTable ADD COLUMN NewColumn',
                                                    );
                                                },
                                                checkDone,
                                                fail,
                                        ...
                                        function() {
                                            db.readTransaction(
                                                function(tx) {
                                                    tx.executeSql(
                                                        'REPLACE INTO test_table VALUES ("another")',
                                                    );
                                                },
                                                checkDone,
                                                fail,
