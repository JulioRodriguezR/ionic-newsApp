...
declare class SocialSharing {
    ...
    share: (
        message?: string,
        subject?: string,
        fileOrFileArray?: string | ArrayLike<string>,
        url?: string,
    ...
    shareViaWhatsApp: (
        ...
        fileOrFileArray?: string | ArrayLike<string>,
        url?: string,
        successCallback?: SocialSharingSuccessCallback<never>,
        errorCallback?: SocialSharingErrorCallback,
    ) => void;
    ...
    shareViaSMS: (
        options?: SocialSharingOptions | string,
    ...
    shareViaEmail: (
        ...
        ccArray?: ArrayLike<string>,
        bccArray?: ArrayLike<string>,
        fileOrFileArray?: string | ArrayLike<string>,
        successCallback?: SocialSharingSuccessCallback<boolean>,
        errorCallback?: SocialSharingErrorCallback,
    ) => void;
...
type SocialSharingW3C = (
    shareData: SocialSharingW3CData,
