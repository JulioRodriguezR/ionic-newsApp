...
SocialSharing.prototype.setIPadPopupCoordinates = function(coords) {
    console.log(
        'Deprecated - setIPadPopupCoordinates no longer works since plugin version 5.5.0. See https://github.com/EddyVerbruggen/SocialSharing-PhoneGap-Plugin/issues/1052',
    );
    // left,top,width,height
    cordova.exec(
        function() {},
...
SocialSharing.prototype.shareW3C = function(sharedata) {
    return new Promise(function(resolve, reject) {
        ...
        if (
            ...
            cordova.exec(resolve, reject, 'SocialSharing', 'shareWithOptions', [
                options,
            ]);
        } else {
            reject();
...
SocialSharing.prototype.shareViaTwitter = function(
    message,
    file /* multiple not allowed by twitter */,
    url,
    successCallback,
    errorCallback,
) {
    ...
    if (fileArray.length > 1) {
        ...
        cordova.exec(successCallback, ecb, 'SocialSharing', 'shareViaTwitter', [
            message,
            null,
            fileArray,
            url,
...
SocialSharing.prototype.shareViaFacebookWithPasteMessageHint = function(
    message,
    fileOrFileArray,
    url,
    pasteMessageHint,
...
SocialSharing.prototype.shareViaWhatsAppToReceiver = function(
    ...
    cordova.exec(
        ...
        'SocialSharing',
        'shareViaWhatsApp',
        [message, null, this._asArray(fileOrFileArray), url, receiver, null],
    );
};
